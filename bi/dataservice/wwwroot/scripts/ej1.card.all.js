...
(function(bbdesigner$, BoldBIDashboard, undefined) {
    BoldBIDashboard.widget('BoldBIDashboardNumberCard', 'BoldBIDashboard.NumberCard', {
		...
		_initializeMargins: function() {
			this.marginTop = window.screen.width < 1920 ? 10 : 31;
			this.marginTopWithSparkline = window.screen.width < 1920 ? 10 : 18;
			this.inBetweenMargin = window.screen.width < 1920 ? 5 : 7;
			this.bottomMargin = 2;
		},
        _wireEvents: function() {
            this._on(this.element, "click", this._selectedHandler);
        ...
        _updateWrapperHeight: function() {
            ...
            this.element.find('.e-number-card-wrapper-parent').css({ 'width': parentWidth + 'px', 'margin-left' : marginLeft + 'px', 'margin-right': marginRight + 'px', 'margin-top': marginTop + 'px', 'margin-bottom' : this.bottomMargin + 'px' });
        ...
        _getFontHight: function(isReturnHt) {
			...
			var margin = (this.element.find('.e-number-card-title-container').hasClass('e-number-card-display-flex') && this.element.find('.e-number-card-content-image-wrapper').hasClass('e-number-card-display-flex') ? (this.inBetweenMargin * 2) : 0) + this.bottomMargin;
            var titleHt = this.element.find('.e-number-card-title-text').height();
			var descriptionHt = this.element.find('.e-number-card-description-text').height() + 10; // 10 - top + bottom margin 
            ...
            var calculatedHeight = (titleHt + dimensionHt + bottomContainerHt + margin);
            var wrapperHt = calculatedHeight;
			if(isReturnHt){
				return wrapperHt;
			}
            if (cardHt < wrapperHt) {
                ...
                if (cardHt >= tempHt) {
                    ...
                    tempHt = wrapperHt - dimensionHt - titleHt;
                    if (cardHt >= tempHt) {
                     if(this._isMeasurePresent() || this._isImagePresent()) {
							this._hideDimension();
							this._hideTitle();
				...
				if(this._isSparklinePresent() && (cardHt + this.marginTop - this.marginTopWithSparkline) < (wrapperHt + 47) && (this._isMeasurePresent() || this._isImagePresent() || this._isTitlePresent())){ // 47 - sparkline min ht
					this._hideSparkline();
				}
			}
            return wrapperHt;
        ...
        _resizeSparklineContainer: function() {
            ...
            // }
			var marginTop = this.element.find('.e-number-card-sparkline-container').hasClass('e-number-card-display-flex') ? this.marginTopWithSparkline : this.marginTop;			
			var sparklineHeight = this.model.size.height - this.margin - this._getFontHight(true) - marginTop - this.bottomMargin;	
		...
		_updateMargin: function() {
			...
			if(this._isImagePresent()) {
				...
				if(this.model.image.position === 'Left'){
					...
					this.element.find('.e-number-card-image-wrapper').css({'margin-left': '0', 'margin-right': '17px'});
				} else {
					this.element.find('.e-number-card-title-container').css({'margin-left':'0px','margin-right': titleMargin});
					this.element.find('.e-number-card-image-wrapper').css({'margin-left': '17px', 'margin-right': '0px'});
				}
			} else {
				this.element.find('.e-number-card-title-container').css({'margin-left':'0px','margin-right':'0px'});
		...
		_updateCardAlignment: function() {
			this.element.find('.e-number-card-wrapper').removeClass('e-number-card-justify-start e-number-card-justify-center e-number-card-justify-end');
