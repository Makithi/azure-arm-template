    ...
    App: {
        LocalizationContent: {
            ...
            dataSource: {
                ...
                extractModeMessage: "<b>Note:</b> Initially, it will extract the records based on the Max Rows selected to proceed with data model creation. Remaining records (no limit) will be extracted during the next refresh.",
